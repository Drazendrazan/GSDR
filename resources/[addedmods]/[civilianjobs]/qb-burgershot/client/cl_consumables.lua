...
RegisterNetEvent('qb-burgershot:client:Eat', function(itemName)
...
RegisterNetEvent('qb-burgershot:client:Drink', function(itemName)
...
RegisterNetEvent('qb-burgershot:client:makeBleeder', function()
    ...
    if ingredients then
        ...
        QBCore.Functions.Progressbar("bs_stuff", "Making a Bleeder..", 8000, false, true, {
            ...
            TriggerServerEvent("qb-burgershot:server:makeBleeder")
            ...
            TriggerEvent('animations:client:EmoteCommandStart', {"c"})
            TriggerEvent('qb-burgershot:client:cookBurgers')
        end, function() -- Cancel
...
RegisterNetEvent('qb-burgershot:client:makeMoneyshot', function()
	local ingredients = QBCore.Functions.HasItem({"burger-bun", "burger-raw", "burger-lettuce", "burger-tomato"})
    if ingredients then
        TriggerEvent('animations:client:EmoteCommandStart', {"fbbq"})
        TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 20.0, "grilling", 0.6)
        QBCore.Functions.Progressbar("bs_stuff", "Making a Moneyshot..", 8000, false, true, {
            ...
            TriggerServerEvent("qb-burgershot:server:makeMoneyshot")
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["burger-bun"], "remove")
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["burger-raw"], "remove")
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["burger-lettuce"], "remove")
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["burger-tomato"], "remove")
...
RegisterNetEvent('qb-burgershot:client:makeHeartstopper', function()
	local ingredients = QBCore.Functions.HasItem({"burger-bun", "burger-raw", "burger-lettuce", "burger-tomato"})
    if ingredients then
        TriggerEvent('animations:client:EmoteCommandStart', {"fbbq"})
        TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 20.0, "grilling", 0.6)
        QBCore.Functions.Progressbar("bs_stuff", "Making a Hearstopper..", 8000, false, true, {
            ...
            TriggerServerEvent("qb-burgershot:server:makeHeartstopper")
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["burger-bun"], "remove")
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["burger-raw"], "remove")
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["burger-lettuce"], "remove")
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["burger-tomato"], "remove")
...
RegisterNetEvent('qb-burgershot:client:makeMeatfree', function()
    ...
    if ingredients then
        ...
        QBCore.Functions.Progressbar("bs_stuff", "Making a Meat free..", 8000, false, true, {
            ...
            TriggerServerEvent("qb-burgershot:server:makeMeatfree")
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["burger-bun"], "remove")
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["burger-lettuce"], "remove")
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["burger-tomato"], "remove")
...
RegisterNetEvent('qb-burgershot:client:makeTorpedo', function()
    ...
    if ingredients then
        ...
        QBCore.Functions.Progressbar("bs_stuff", "Making a Torpedo..", 8000, false, true, {
            ...
            TriggerServerEvent("qb-burgershot:server:makeTorpedo")
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["burger-bun"], "remove")
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["burger-raw"], "remove")
...
RegisterNetEvent('qb-burgershot:client:makeFries', function()
    ...
    if ingredients then
        ...
        QBCore.Functions.Progressbar("bs_stuff", "Making some crispy fries..", 10000, false, true, {
            ...
            TriggerServerEvent("qb-burgershot:server:makeFries")
...
RegisterNetEvent('qb-burgershot:client:makeSoda', function()
    ...
    if ingredients then
        ...
        QBCore.Functions.Progressbar("bs_stuff", "Making Drinks..", 8000, false, true, {
            ...
            TriggerServerEvent("qb-burgershot:server:makeSoda")
...
RegisterNetEvent('qb-burgershot:client:makeShake', function()
    ...
    if ingredients then
        ...
        QBCore.Functions.Progressbar("bs_stuff", "Making Drinks..", 8000, false, true, {
            ...
            TriggerServerEvent("qb-burgershot:server:makeShake")
...
RegisterNetEvent('qb-burgershot:closemenu', function()
    ClearPedTasksImmediately(PlayerPedId())
    TriggerEvent("qb-menu:closeMenu")
end)

RegisterNetEvent('qb-burgershot:client:cookBurgers', function()
    ...
    exports['qb-menu']:openMenu({
        ...
        },
        {
            ...
            params = {
                event = "qb-burgershot:client:makeBleeder",
            }
        },
        {
            ...
            icon = "fa-solid fa-burger",
            params = {
                event = "qb-burgershot:client:makeMoneyshot",
            }
        },
        {
            ...
            icon = "fa-solid fa-burger",
            params = {
                event = "qb-burgershot:client:makeTorpedo",
            }
        },
        {
            ...
            icon = "fa-solid fa-burger",
            params = {
                event = "qb-burgershot:client:makeHeartstopper",
            }
        },
        {
            ...
            icon = "fa-solid fa-burger",
            params = {
                event = "qb-burgershot:client:makeMeatfree",
            }
        },
        {
            header = "Exit",
            ...
            params = {
                event = "qb-burgershot:closemenu"
            }
        },
    })
end)

RegisterNetEvent('qb-burgershot:client:drinkStation', function()
    ...
    exports['qb-menu']:openMenu({
        ...
        },
        {
            ...
            params = {
                event = "qb-burgershot:client:makeSoda",
            }
        },
        {
            ...
            icon = "fa-solid fa-mug-hot",
            params = {
                event = "qb-burgershot:client:makeShake",
            }
        },
        {
            header = "Exit",
