...
function BurgerZones()
	...
	exports['qb-target']:AddTargetEntity(jobPed, { 
		...
		{ 
		    type = "client",
		    event = "qb-burgershot:client:jobGarage",
		...
		{ 
		    type = "client",
		    event = "qb-burgershot:client:storeGarage",
		    icon = "fa-solid fa-clipboard-check",
		    label = "Store Vehicle",
		    job = "burgershot"
		},
...
RegisterNetEvent('qb-burgershot:client:jobGarage', function(vehicle)
...
RegisterNetEvent('qb-burgershot:client:storeGarage', function()
...
RegisterNetEvent("qb-burgershot:client:frontTray", function()
...
RegisterNetEvent("qb-burgershot:client:frontTray2", function()
...
RegisterNetEvent("qb-burgershot:client:passThrough", function()
...
RegisterNetEvent("qb-burgershot:client:jobFridge", function()
...
RegisterNetEvent("qb-burgershot:client:ingredientStore", function()
    TriggerServerEvent("inventory:server:OpenInventory", "shop", "burgershot", Config.Items)
end)

RegisterNetEvent('qb-burgershot:clientToggleDuty', function()
...
RegisterNetEvent("qb-burgershot:bill", function()
    ...
    if bill ~= nil then
        ...
        TriggerServerEvent("qb-burgershot:server:billPlayer", bill.citizenid, bill.billprice)
    end
end)
