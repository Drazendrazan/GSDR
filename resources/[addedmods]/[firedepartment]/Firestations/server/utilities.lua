...
local resourceName = "Firestations"

CreateThread(function()
    if GetCurrentResourceName() ~= "Firestations" then
        resourceName = "Firestations (" .. GetCurrentResourceName() .. ")"
...
GetRepoInformations = function()
    local repoVersion, repoURL = curVersion, "https://github.com/Wick89/Firestations"
