...
RegisterNetEvent("md-drugs:client:cutcoketwo")
AddEventHandler("md-drugs:client:cutcoketwo", function() 
    RequestAnimDict("mp_arresting")
        while (not HasAnimDictLoaded("mp_arresting")) do
        Citizen.Wait(4000)
        end
    ...
    QBCore.Functions.Progressbar("drink_something", "cutting coke to increase profits yeeee!", 4000, false, true, {
	    ...
	    TriggerServerEvent("md-drugs:server:cutcoketwo")
        Citizen.Wait(4000)
...
RegisterNetEvent("md-drugs:client:cutcokethree")
AddEventHandler("md-drugs:client:cutcokethree", function() 
    RequestAnimDict("mp_arresting")
        while (not HasAnimDictLoaded("mp_arresting")) do
        Citizen.Wait(4000)
        end
    ...
    QBCore.Functions.Progressbar("drink_something", "cutting coke to increase profits yeeee!", 4000, false, true, {
	    ...
	    TriggerServerEvent("md-drugs:server:cutcokethree")
        Citizen.Wait(4000)
...
RegisterNetEvent("md-drugs:client:bagcoketwo")
AddEventHandler("md-drugs:client:bagcoketwo", function() 
    RequestAnimDict("mp_arresting")
        while (not HasAnimDictLoaded("mp_arresting")) do
        Citizen.Wait(4000)
        end
    ...
    QBCore.Functions.Progressbar("drink_something", "Bilbo Baggin this bitch!", 4000, false, true, {
	    ...
	    TriggerServerEvent("md-drugs:server:bagcoketwo")
        Citizen.Wait(4000)
...
RegisterNetEvent("md-drugs:client:bagcokethree")
AddEventHandler("md-drugs:client:bagcokethree", function() 
    RequestAnimDict("mp_arresting")
        while (not HasAnimDictLoaded("mp_arresting")) do
        Citizen.Wait(4000)
        end
    ...
    QBCore.Functions.Progressbar("drink_something", "Bilbo Baggin this bitch!", 4000, false, true, {
	    ...
	    TriggerServerEvent("md-drugs:server:bagcokethree")
        Citizen.Wait(4000)
